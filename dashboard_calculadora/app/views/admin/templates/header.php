        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="http://localhost/dashboard_calculadora/app/views/admin/index.php" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./create_user.php" class="menu-link">
                    <div data-i18n="Notifications">Agregar Nuevo</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./view_user.php" class="menu-link">
                    <div data-i18n="Connections">Gestionar Todo</div>
                  </a>
                </li>
              </ul>
            </li>
